    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", padding: "32px 24px",
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
          11 May – 7 Jul 2026 · Unique contacts · last form only per contact · W9 partial ⚡
        </p>
      </div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24, flexWrap: "wrap" }}>
        {[
          { label: "Total Enquiries (LO)",       value: totalEnq,       sub: `avg ${avgEnq}/wk (W1–W8)`, color: COLORS.enq  },
          { label: "Total Applications (LO+OA)", value: totalApp,       sub: `avg ${avgApp}/wk (W1–W8)`, color: COLORS.app  },
          ...
          { label: "W8 (latest full week)",      value: data[7].total,  sub: `${data[7].enq}e / ${data[7].app}a`, color: "#cbd5e1" },
        ].map(k => (
