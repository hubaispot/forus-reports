...
const data = [
  ...
  { week: "27 Apr–3 May", enq: 2, app: 4,  full: true  },
  { week: "4–10 May",     enq: 2, app: 4,  full: true  },
  { week: "11–17 May",    enq: 3, app: 1,  full: true  },
  { week: "18–24 May",    enq: 2, app: 2,  full: true  },
    ...
    <div style={{ background:"#0f172a", minHeight:"100vh", padding:"32px 24px",
      ...
      <div style={{ marginBottom:24 }}>
        ...
        <p style={{ margin:0, color:"#94a3b8", fontSize:13 }}>
          13 Apr – 7 Jun 2026 · 8 complete weeks · Unique contacts · last form only per contact
        </p>
      </div>
      ...
      <div style={{ background:"rgba(52,211,153,0.08)", border:"1px solid #34d399", borderRadius:8,
        ...
        CTID379 has a <strong style={{ color:"#f1f5f9" }}>strong {overallApp}% overall application rate</strong> —
        applications outnumber enquiries in 5 of 8 weeks, with 5 weeks hitting 🔥 ≥60%.
        W1 (89%) and W2 (100%) were standout weeks of very high direct intent.
        W5 was the only week enquiries led (25%). W8 closes the window evenly at 50% with the highest volume (12 submissions).
      </div>
      ...
      <div style={{ display:"flex", gap:10, marginBottom:24, flexWrap:"wrap" }}>
        {[
          ...
          { label:"Weeks ≥60% App Rate", value:"5 / 8",      sub:"🔥 high-intent wks", color:"#fbbf24"  },
        ].map(k => (
        ...
        <ResponsiveContainer width="100%" height={300}>
          {view === "rate" ? (
            <ComposedChart data={data} margin={{ top:8, right:20, left:-8, bottom:8 }}>
              ...
              <ReferenceLine y={60} stroke="#334155" strokeDasharray="2 4"
                label={{ value:"60% threshold", fill:"#475569", fontSize:10, position:"insideBottomRight" }}/>
      ...
      <p style={{ marginTop:16, fontSize:11, color:"#475569", textAlign:"center" }}>
        8 complete weeks · 13 Apr – 7 Jun 2026 · Unique contacts, last CTID379 form only · Generated 7 Jun 2026
      </p>
    </div>
  );
}
