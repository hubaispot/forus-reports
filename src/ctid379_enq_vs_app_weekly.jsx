...
export const data = [
  ...
  { week: "10–12 Aug ⚡",    enq: 2,  app: 2, full: false },
    ...
    <div style={{ background:"#0f172a", minHeight:"100vh", padding:"32px 24px",
      ...
      <div style={{ marginBottom:24 }}>
        <p style={{ color:"#64748b", fontSize:12, textTransform:"uppercase", letterSpacing:"0.08em", margin:"0 0 6px" }}>
          HubSpot · SNA Level 6 – Live and Online (CTID379) · Updated 12 Aug 2026
        </p>
        <h1 style={{ margin:"0 0 4px", fontSize:22, fontWeight:700, color:"#f8fafc" }}>
          Weekly Form Submissions — Enquiry vs Application
        </h1>
        <p style={{ margin:0, color:"#94a3b8", fontSize:13 }}>
          15 Jun – 12 Aug 2026 · Unique contacts · last form only per contact
        </p>
      </div>
      ...
      <div style={{ background:"rgba(52,211,153,0.08)", border:"1px solid #34d399", borderRadius:8,
        ...
        <strong style={{ color:"#34d399" }}>📌 Key trend: </strong>
        Enquiry volume has been <strong style={{ color:"#f1f5f9" }}>strong but application conversion has softened</strong> —
        W3 (29 Jun–5 Jul) saw a spike of 18 enquiries but only 3 applications. W6 and W8 recorded zero
        applications. W9 is showing early signs of recovery with 2 apps in just 3 days.
      </div>
