      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24, flexWrap: "wrap" }}>
        {[
          ...
          ...(data[data.length - 1].full
            ? [{
                label: `W${data.length} (full week)`,
                value: data[data.length - 1].total,
                sub: `${data[data.length - 1].enq}e / ${data[data.length - 1].app}a`,
                color: "#cbd5e1"
              }]
            : [{
          ...
          <div key={k.label} style={{
            ...
            <p style={{
              margin: "0 0 3px", fontSize: 10, color: "#64748b",
          ...
          {view === "rate" ? (
            <ComposedChart data={data} margin={{ top: 8, right: 20, left: -8, bottom: 8 }}>
              ...
              <ReferenceLine
                ...
                strokeDasharray="4 3"
                label={{
                  value: `Avg ${overallApp}%`,
                  fill: "#64748b", fontSize: 11, position: "insideTopRight"
                }}
              />
              <Line
                dataKey="appRate"
                ...
                stroke="#34d399"
                strokeWidth={2.5}
                dot={{ r: 6, fill: "#34d399", strokeWidth: 0 }}
                connectNulls
              />
            </ComposedChart>
          ) : (
            <ComposedChart
              ...
              barCategoryGap={view === "stacked" ? "30%" : "22%"}
              barGap={4}
            >
              <CartesianGrid strokeDasharray="3 3" stroke="#334155" vertical={false} />
              <XAxis
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>
              ...
              return (
                <tr key={i} style={{
                  ...
                  <td style={{ padding: "11px 14px", color: "#cbd5e1" }}>
                    {row.week}
                    {!row.full && (
                      <span style={{ marginLeft: 5, color: "#fbbf24", fontSize: 10 }}>⚡</span>
                    )}
                  </td>
                  <td style={{
                  ...
                  <td style={{
                    padding: "11px 14px", textAlign: "center",
                    fontWeight: 700, color: "#f1f5f9", fontSize: 15
                  }}>{row.total}</td>
                  <td style={{
                    padding: "11px 14px", textAlign: "center",
            ...
            <tr style={{ background: "#0f172a", borderTop: "2px solid #334155" }}>
              ...
              <td style={{
                padding: "11px 14px", textAlign: "center",
                fontWeight: 800, color: COLORS.enq, fontSize: 15
              }}>{totalEnq}</td>
              <td style={{
                padding: "11px 14px", textAlign: "center",
                fontWeight: 800, color: COLORS.app, fontSize: 15
              }}>{totalApp}</td>
              <td style={{
                padding: "11px 14px", textAlign: "center",
                fontWeight: 800, color: "#f1f5f9", fontSize: 15
              }}>{total}</td>
              <td style={{
                padding: "11px 14px", textAlign: "center",
                fontWeight: 700, color: "#34d399", fontSize: 13
              }}>{overallApp}%</td>
            </tr>
          </tbody>
        </table>
