...
// Reporting cycle: W1 (13 Apr 2026) → W9 (14 Jun 2026)
// All weeks Mon 00:00 → Sun 23:59 IST (UTC+1 / BST)
// Methodology: last form only per contact (recent_conversion_event_name)
// All 9 weeks are full (full: true) — W9 closes 14 Jun 2026 as requested
// ─────────────────────────────────────────────────────────────────────────────
export const data = [
  ...
  { week: "1–7 Jun",      enq: 6,  app: 5,  full: true },
    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", padding: "32px 24px",
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
          13 Apr – 14 Jun 2026 · W1–W9 · Unique contacts · last form only per contact
        </p>
      </div>
      ...
      <div style={{ background: "rgba(52,211,153,0.08)", border: "1px solid #34d399", borderRadius: 8,
        ...
        CTID379 has a <strong style={{ color: "#f1f5f9" }}>very high application rate ({overallApp}%)</strong> —
        applications outnumber enquiries in 6 of 9 weeks. W8 (1–7 Jun) was the busiest week overall (11 submissions).
        W9 (8–14 Jun) closed strongly with 6 applications, the joint-highest application week alongside W1.
      </div>
        ...
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>
            ...
            <tr style={{ background: "#0f172a", borderTop: "2px solid #334155" }}>
              ...
              <td style={{ padding: "11px 14px", textAlign: "center", fontWeight: 800, color: COLORS.enq, fontSize: 15 }}>{totalEnq}<span style={{ fontSize: 10, marginLeft: 4, color: "#64748b" }}>({avgEnq}/wk)</span></td>
              <td style={{ padding: "11px 14px", textAlign: "center", fontWeight: 800, color: COLORS.app, fontSize: 15 }}>{totalApp}<span style={{ fontSize: 10, marginLeft: 4, color: "#64748b" }}>({avgApp}/wk)</span></td>
      ...
      <p style={{ marginTop: 16, fontSize: 11, color: "#475569", textAlign: "center" }}>
        Data: HubSpot CRM · recent_conversion_event_name · last form only per contact · IST week boundaries ·
        Fetched 15 Jun 2026 · All 9 weeks closed (W9 end = Sun 14 Jun 23:59 IST)
      </p>
    </div>
  );
}
