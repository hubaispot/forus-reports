...
// Full re-run from CSVs 29 Jun 2026 · 111 unique enquiries · 98 unique apps
// ─────────────────────────────────────────────────────────────────────────────
export const data = [
  ...
  { week: "22–28 Jun",   enq: 18, app: 17, full: true },
].map(d => ({
  ...d,
  total: d.enq + d.app,
    ...
    <div style={{
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
          4 May – 28 Jun 2026 · 8 full weeks · Unique contacts · global dedup per form
        </p>
      </div>
      ...
      <div style={{
        ...
        W5 (1–7 Jun) was the peak enquiry week with 47 total submissions and 20 applications.
        ...
        W8 (22–28 Jun) has rebounded strongly with 18 enquiries and 17 applications at 49% app rate.
      </div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24, flexWrap: "wrap" }}>
        {[
          ...
          { label: "W8 (22–28 Jun)",     value: "18e / 17a",    sub: "49% app rate",       color: "#fbbf24"  },
        ].map(k => (
      ...
      <p style={{ marginTop: 14, fontSize: 11, color: "#475569", textAlign: "center" }}>
        Global dedup per form · most recent submission kept per contact · 29 Jun 2026
      </p>
