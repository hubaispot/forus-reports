...
// ─── RAW DEAL DATA (fetched 29 Aug 2026) ─────────────────────────────────────
...
const RAW_DEALS = [
  ...
  {id:"509883560184",dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Kellyanne delaney",createdate:"2026-07-10T17:52:15.071Z",stage:"won",amount:440},
  ...
  {id:"510487579893",dealname:"Barista training (1169 CNY DBU) - Mullingar for Christopher Bookless",createdate:"2026-07-16T15:57:01.702Z",stage:"app",amount:0},
  ...
  {id:"515286597854",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for Katie Tunney",createdate:"2026-08-07T12:59:48.848Z",stage:"app",amount:440},
  ...
  {id:"515811014871",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for Lucy Cassidy",createdate:"2026-08-10T23:33:34.830Z",stage:"app",amount:440},
  ...
  {id:"518548713706",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Killarney for Martina Cerrotta",createdate:"2026-08-27T16:24:31.806Z",stage:"app",amount:440},
  ...
  {id:"518599872730",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Buncrana for Shaciara Mc Callion",createdate:"2026-08-27T16:41:38.807Z",stage:"app",amount:440},
  ...
  {id:"518545470660",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Castlebar for Helena Dockery",createdate:"2026-08-27T20:38:02.292Z",stage:"app",amount:440},
  ...
  {id:"518644255938",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Killarney for Caoimhe Lehane",createdate:"2026-08-28T10:09:04.392Z",stage:"app",amount:440},
  ...
  {id:"518654447807",dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Enniscorthy for Norma Tully",createdate:"2026-08-28T11:23:40.408Z",stage:"won",amount:440},
  ...
  {id:"507703439553w",dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Katie Smith",createdate:"2026-06-20T00:00:00Z",stage:"won",amount:440},
];
...
// ─── WEEK BUCKETS ─────────────────────────────────────────────────────────────
const WEEKS = [
  {wk:"W1",label:"29 Jun–5 Jul",start:new Date("2026-06-28T23:00:00Z"),end:new Date("2026-07-05T22:59:59Z"),full:true},
  {wk:"W2",label:"6 Jul–12 Jul",start:new Date("2026-07-05T23:00:00Z"),end:new Date("2026-07-12T22:59:59Z"),full:true},
  {wk:"W3",label:"13 Jul–19 Jul",start:new Date("2026-07-12T23:00:00Z"),end:new Date("2026-07-19T22:59:59Z"),full:true},
  {wk:"W4",label:"20 Jul–26 Jul",start:new Date("2026-07-19T23:00:00Z"),end:new Date("2026-07-26T22:59:59Z"),full:true},
  {wk:"W5",label:"27 Jul–2 Aug",start:new Date("2026-07-26T23:00:00Z"),end:new Date("2026-08-02T22:59:59Z"),full:true},
  {wk:"W6",label:"3 Aug–9 Aug",start:new Date("2026-08-02T23:00:00Z"),end:new Date("2026-08-09T22:59:59Z"),full:true},
  {wk:"W7",label:"10 Aug–16 Aug",start:new Date("2026-08-09T23:00:00Z"),end:new Date("2026-08-16T22:59:59Z"),full:true},
  {wk:"W8",label:"17 Aug–23 Aug",start:new Date("2026-08-16T23:00:00Z"),end:new Date("2026-08-23T22:59:59Z"),full:true},
  {wk:"W9",label:"24 Aug–29 Aug ⚡",start:new Date("2026-08-23T23:00:00Z"),end:new Date("2026-08-29T10:33:18Z"),full:false},
];
    ...
    <div style={{ background:C.bg, minHeight:"100vh", padding:"28px 24px", fontFamily:"'Inter','Segoe UI',sans-serif", color:C.text, textAlign:"left" }}>
      ...
      <div style={{ marginBottom:20 }}>
        ...
        <p style={{ margin:0, color:C.sub, fontSize:13 }}>
          29 Jun – 29 Aug 2026 · deal create date · ⚡ W9 partial week
        </p>
      </div>
      ...
      <p style={{ marginTop:16, fontSize:10, color:C.muted, textAlign:"right" }}>
        Data: HubSpot B2C (Single Modules) pipeline · fetched 29 Aug 2026 · deal create date as week anchor
      </p>
    </div>
  );
}
