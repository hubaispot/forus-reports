...
// ─── RAW DEAL DATA (fetched 31 Aug 2026) ─────────────────────────────────────
...
const RAW_DEALS = [
  ...
  { id:"511245735098", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Killarney for Marie O Sullivan o shea", createdate:"2026-07-18T13:06:40Z", stage:"app", amount:440 },
  ...
  { id:"517307384038", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Rebecca Gibney Armstrong", createdate:"2026-08-18T06:01:13Z", stage:"app", amount:440 },
  ...
  { id:"518169528526", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Buncrana for Catherine Harkin", createdate:"2026-08-25T17:01:20Z", stage:"app", amount:440 },
  ...
  { id:"518260676798", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Athenry for Bernie Burke", createdate:"2026-08-25T18:14:02Z", stage:"app", amount:440 },
  ...
  { id:"518443276482", dealname:"Psychology - Online Anytime 1:1 (5N0754 OA DHC) -  for Fiona Larkin", createdate:"2026-08-26T13:03:14Z", stage:"app", amount:295 },
  ...
  { id:"518545470660", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Castlebar for Helena Dockery", createdate:"2026-08-27T20:38:02Z", stage:"app", amount:440 },
  ...
  { id:"518827481294", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Midleton for Claire O Flynn", createdate:"2026-08-29T21:22:34Z", stage:"app", amount:440 },
  ...
  { id:"519052082412", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Midleton for Claire Murray", createdate:"2026-08-31T10:56:07Z", stage:"won", amount:440 },
  { id:"519010627791", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Buncrana for Geraldine Sweeney", createdate:"2026-08-31T10:57:14Z", stage:"app", amount:440 },
  { id:"518962920650", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Killarney for Caoimhe Lehane", createdate:"2026-08-31T11:20:11Z", stage:"won", amount:440 },
  ...
  { id:"519068197096", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Castlebar for Lena Dockery", createdate:"2026-08-31T13:37:00Z", stage:"won", amount:440 },
  ...
  { id:"508501238006", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Caoimhe Ryan", createdate:"2026-06-13T10:00:00Z", stage:"won", amount:295 },
  { id:"508786105591", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Ursula Dobson", createdate:"2026-06-17T10:00:00Z", stage:"won", amount:440 },
  { id:"509468536006", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Nora McCormack", createdate:"2026-06-23T10:00:00Z", stage:"won", amount:440 },
  { id:"507703439553", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Katie Smith", createdate:"2026-06-29T10:00:00Z", stage:"app", amount:0 },
  { id:"507703439553w", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Katie Smith", createdate:"2026-06-29T10:00:00Z", stage:"won", amount:440 },
];
...
const WEEKS = [
  ...
  { wk:"W9", label:"31 Aug–31 Aug ⚡", start:new Date("2026-08-30T23:00:00Z"), end:new Date("2026-08-31T16:11:10Z"), full:false },
];
    ...
    <div style={{ background:C.bg, minHeight:"100vh", padding:"28px 24px", fontFamily:"'Inter','Segoe UI',sans-serif", color:C.text, textAlign:"left" }}>
      ...
      <div style={{ marginBottom:20 }}>
        ...
        <p style={{ margin:0, color:C.sub, fontSize:13 }}>
          6 Jul – 31 Aug 2026 · deal create date · ⚡ W9 partial week
        </p>
      </div>
      ...
      <p style={{ marginTop:16, fontSize:10, color:C.muted, textAlign:"right" }}>
        Data: HubSpot B2C (Single Modules) pipeline · fetched 31 Aug 2026 · deal create date as week anchor
      </p>
    </div>
  );
}
