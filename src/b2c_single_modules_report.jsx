...
// ─── RAW DEAL DATA (fetched 2 Sep 2026) ──────────────────────────────────────
// Stages: 5381718219 + 5381718220 = Application received | 756357056 = Won
// Rolling window: W1 6 Jul – W9 2 Sep 2026 (W9 partial ⚡)
// Pre-window kept deals (graduated from pipeline 110199236):
//   508501238006 Caoimhe Ryan | 508786105591 Ursula Dobson | 509468536006 Nora McCormack
// Synthetic dual-entry: 507703439553 / 507703439553w Katie Smith
// Dups removed this run: 511245735098, 512132184307, 513368690922, 516939040974,
//   517307384038, 517256741058, 517490761942, 518260676798, 518443276482, 518436133061,
//   518548713706, 518858447088, 518880552158, 519122991340, 519334933753, 519263152343,
//   519335516383, 510647687417, 512135469282, 518169528526, 513662416114, 515746208954
const RAW_DEALS = [
  ...
  // ── Pre-window kept deals (graduated from pipeline 110199236) ──
  { id:"508501238006", dealname:"Special Needs Assisting - Online Anytime 1:1 (6N1957 OA DSN) -  for Caoimhe Ryan",                                                        createdate:"2026-06-29T12:00:00Z", stage:"won", amount:295 },
  { id:"508786105591", dealname:"Work Experience (Healthcare) - Online Anytime 1:1 (5N1356 OA DHC) -  for Ursula Dobson",                                                  createdate:"2026-06-30T12:00:00Z", stage:"won", amount:440 },
  { id:"509468536006", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Nora McCormack",                                                     createdate:"2026-07-02T12:00:00Z", stage:"won", amount:440 },
  // ── Deals from pre-window still kept (Barnes, Aishling, Jamie, Molly, etc.) ──
  ...
  { id:"510615946436", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for SANDRA O'BRIEN", createdate:"2026-07-17T09:48:02Z", stage:"app", amount:440 },
  ...
  { id:"511989268723", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for SANDRA O'BRIEN", createdate:"2026-07-21T22:17:48Z", stage:"app", amount:440 },
  ...
  { id:"517256741058", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - New Ross for Fern Bohill", createdate:"2026-08-18T06:27:29Z", stage:"app", amount:440 },
  ...
  { id:"517413922030", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Mullingar for Noelle Slowey", createdate:"2026-08-18T16:19:56Z", stage:"app", amount:440 },
  { id:"517477645505", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for Lisa McCabe", createdate:"2026-08-18T18:23:13Z", stage:"app", amount:440 },
  ...
  { id:"517490761942", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Shauna Mcdonnell", createdate:"2026-08-19T07:52:20Z", stage:"app", amount:440 },
  ...
  { id:"517467616448", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Sam Crawford", createdate:"2026-08-19T14:31:29Z", stage:"app", amount:440 },
  ...
  { id:"517700284617", dealname:"Special Needs Assisting - Online Anytime 1:1 (6N1957 OA DSN) -  for sandra loughlin",                                                    createdate:"2026-08-20T16:15:06Z", stage:"app", amount:455 },
  ...
  { id:"518188957886", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Cavan for Enya O Rourke",                                                createdate:"2026-08-25T14:19:18Z", stage:"app", amount:440 },
  ...
  { id:"518169528526", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Buncrana for Catherine Harkin (TP, dup removed: 518169528526)",          createdate:"2026-08-25T17:01:20Z", stage:"app", amount:440 },
  ...
  { id:"518273340619", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Enniscorthy for Catherine Murphy",                                       createdate:"2026-08-25T20:39:56Z", stage:"app", amount:440 },
  ...
  { id:"518548713706", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Killarney for Martina Cerrotta",                                         createdate:"2026-08-27T16:24:31Z", stage:"app", amount:440 },
  ...
  { id:"518850327742", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for Hazel Nolan",                                                  createdate:"2026-08-29T20:45:04Z", stage:"app", amount:440 },
  ...
  { id:"518852576478", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Mairead O malley",                                                  createdate:"2026-08-30T13:15:04Z", stage:"app", amount:440 },
  { id:"518947932397", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Buncrana for Karen Mccolgan",                                            createdate:"2026-08-30T14:48:20Z", stage:"app", amount:440 },
  ...
  { id:"519020206329", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Navan for Michelle O Connor",                                            createdate:"2026-08-30T22:31:28Z", stage:"app", amount:440 },
  ...
  { id:"519089915125", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Gemma Gooney",                                                     createdate:"2026-09-01T17:49:51Z", stage:"app", amount:440 },
  ...
  { id:"519132041420", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Carrick on Shannon for Edel Baxter",                                     createdate:"2026-09-01T21:31:22Z", stage:"app", amount:440 },
  ...
  { id:"519316853963", dealname:"Special Needs Assisting - Classroom Near You (6N1957 CNY DSN) - Cavan for Lisa McGovern",                                                createdate:"2026-09-02T09:05:35Z", stage:"app", amount:440 },
  ...
  { id:"519335971003", dealname:"Special Needs Assisting - Online Anytime 1:1 (6N1957 OA DSN) -  for Josephine Carolan",                                                  createdate:"2026-09-02T10:31:32Z", stage:"app", amount:455 },
  ...
  { id:"519342557412", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Angela Gillespie",                                                  createdate:"2026-09-02T12:52:27Z", stage:"app", amount:440 },
  ...
  { id:"519477075146", dealname:"Special Needs Assisting - Online Anytime 1:1 (5N1786 OA DSN) -  for Emma O'Connell",                                                    createdate:"2026-09-02T15:13:00Z", stage:"app", amount:295 },
];
...
// ─── WEEK BUCKETS ─────────────────────────────────────────────────────────────
const WEEKS = [
  { wk:"W1", label:"6 Jul–12 Jul",    start:new Date("2026-07-05T23:00:00Z"), end:new Date("2026-07-12T22:59:59Z"), full:true  },
  { wk:"W2", label:"13 Jul–19 Jul",   start:new Date("2026-07-12T23:00:00Z"), end:new Date("2026-07-19T22:59:59Z"), full:true  },
  { wk:"W3", label:"20 Jul–26 Jul",   start:new Date("2026-07-19T23:00:00Z"), end:new Date("2026-07-26T22:59:59Z"), full:true  },
  { wk:"W4", label:"27 Jul–2 Aug",    start:new Date("2026-07-26T23:00:00Z"), end:new Date("2026-08-02T22:59:59Z"), full:true  },
  { wk:"W5", label:"3 Aug–9 Aug",     start:new Date("2026-08-02T23:00:00Z"), end:new Date("2026-08-09T22:59:59Z"), full:true  },
  { wk:"W6", label:"10 Aug–16 Aug",   start:new Date("2026-08-09T23:00:00Z"), end:new Date("2026-08-16T22:59:59Z"), full:true  },
  { wk:"W7", label:"17 Aug–23 Aug",   start:new Date("2026-08-16T23:00:00Z"), end:new Date("2026-08-23T22:59:59Z"), full:true  },
  { wk:"W8", label:"24 Aug–30 Aug",   start:new Date("2026-08-23T23:00:00Z"), end:new Date("2026-08-30T22:59:59Z"), full:true  },
  { wk:"W9", label:"31 Aug–2 Sep ⚡", start:new Date("2026-08-30T23:00:00Z"), end:new Date("2026-09-02T15:34:34Z"), full:false },
];
    ...
    <div style={{ background:C.bg, minHeight:"100vh", padding:"28px 24px", fontFamily:"'Inter','Segoe UI',sans-serif", color:C.text, textAlign:"left" }}>
      ...
      <div style={{ marginBottom:20 }}>
        ...
        <p style={{ margin:0, color:C.sub, fontSize:13 }}>
          6 Jul – 2 Sep 2026 · W1–W8 full · ⚡ W9 partial
        </p>
      </div>
      ...
      <p style={{ marginTop:16, fontSize:10, color:C.muted, textAlign:"right" }}>
        Data: HubSpot B2C (Single Modules) pipeline · fetched 2 Sep 2026 · deal create date as week anchor
      </p>
    </div>
  );
}
