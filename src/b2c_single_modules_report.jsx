...
// ─── RAW DEAL DATA (fetched 7 Aug 2026) ──────────────────────────────────────
...
// Exclusions this run: Jean Baeyens test, 4x Kabir Singh Mann test, 2x TEST TEST,
//   Emna Stapleton typo dup, Paul Garry dup app, Oran Molloy dup app,
//   2x Kinga/Kania Kania won dups, Catherine Nolan dup app, Catherine Cunningham dup app,
//   Leanne Noonan (moved to untracked stage),
//   2x Sandra O'Brien dup apps (keep most recent 513662416114),
//   Marie O Shea dup apps (keep most recent 513618836721 + won 514669152498),
//   Serena O'Kane dup app (keep most recent 513338051827),
//   Kathleen Gallagher L6 dup app (keep L5 513684338903),
//   Kieran Clifford dup app (keep most recent 515269679351)
// Graduated-but-kept (pipeline 110199236): Caoimhe Ryan 508501238006, Ursula Dobson 508786105591, Nora McCormack 509468536006
// Dual entries retained: Katie Smith 507703439553 app + 507703439553w won override,
//   Aishling Archbold 508289062075+508295524561, Molly Maher 509638378694+509651830991,
//   Barnes 508239231184+509632365764
export const RAW_DEALS = [
  ...
  { id:"506231288040", dealname:"Anatomy and Physiology - Online Anytime 1:1 (5N0749 OA DHC) -  for Mc loughlin Mc loughlin",                            createdate:"2026-06-16T20:36:09Z", stage:"app", amount:295 },
  ...
  { id:"508786105591", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Ursula Dobson",                                   createdate:"2026-07-01T12:00:00Z", stage:"won", amount:440 },
  ...
  { id:"515269679351", dealname:"Special Needs Assisting - Live and Online (6N1957 LO DSN) - Zoom for Kieran Clifford",                      createdate:"2026-08-06T22:31:20Z", stage:"app", amount:440 },
...
function parseDeal(d) {
  // Use matchAll to find the LAST parenthetical block (handles deals with prefix parens like "(Existing Learners)")
  ...
  for (const t of tokens.slice(1)) {
    if (DELIV_MAP[t] && !delivCode) delivCode = t;
    if (DEPT_MAP[t]  && !deptCode)  deptCode  = t;
  }
  ...
  let rawName = m
    ...
    : d.dealname;
  // Strip all parentheticals (e.g. "(Existing Learners)")
...
// ─── WEEK BUCKETS ─────────────────────────────────────────────────────────────
// Rolling window: 8 full weeks (Mon–Sun IST) ending last Sunday + W9 partial (current week to now)
const WEEKS = [
  { wk:"W1", label:"8 Jun–14 Jun",    start:new Date("2026-06-07T23:00:00Z"), end:new Date("2026-06-14T22:59:59Z"), full:true  },
  { wk:"W2", label:"15 Jun–21 Jun",   start:new Date("2026-06-14T23:00:00Z"), end:new Date("2026-06-21T22:59:59Z"), full:true  },
  { wk:"W3", label:"22 Jun–28 Jun",   start:new Date("2026-06-21T23:00:00Z"), end:new Date("2026-06-28T22:59:59Z"), full:true  },
  { wk:"W4", label:"29 Jun–5 Jul",    start:new Date("2026-06-28T23:00:00Z"), end:new Date("2026-07-05T22:59:59Z"), full:true  },
  { wk:"W5", label:"6 Jul–12 Jul",    start:new Date("2026-07-05T23:00:00Z"), end:new Date("2026-07-12T22:59:59Z"), full:true  },
  { wk:"W6", label:"13 Jul–19 Jul",   start:new Date("2026-07-12T23:00:00Z"), end:new Date("2026-07-19T22:59:59Z"), full:true  },
  { wk:"W7", label:"20 Jul–26 Jul",   start:new Date("2026-07-19T23:00:00Z"), end:new Date("2026-07-26T22:59:59Z"), full:true  },
  { wk:"W8", label:"27 Jul–2 Aug",    start:new Date("2026-07-26T23:00:00Z"), end:new Date("2026-08-02T22:59:59Z"), full:true  },
  { wk:"W9", label:"3 Aug–7 Aug ⚡",  start:new Date("2026-08-02T23:00:00Z"), end:new Date("2026-08-07T10:12:04Z"), full:false },
];
    ...
    <div style={{ background:C.bg, minHeight:"100vh", padding:"28px 24px", fontFamily:"'Inter','Segoe UI',sans-serif", color:C.text, textAlign:"left" }}>
      ...
      <div style={{ marginBottom:20 }}>
        ...
        <p style={{ margin:0, color:C.sub, fontSize:13 }}>
          8 Jun – 7 Aug 2026 · deal create date · ⚡ W9 partial week
        </p>
      </div>
      ...
      <p style={{ marginTop:16, fontSize:10, color:C.muted, textAlign:"right" }}>
        Data: HubSpot B2C (Single Modules) pipeline · fetched 7 Aug 2026 · deal create date as week anchor
      </p>
    </div>
  );
}
