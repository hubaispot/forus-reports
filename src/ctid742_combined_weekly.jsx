...
// Combined weekly report: HubSpot forms + Paythen registrations & revenue
// Rolling window: Mon 15 Jun – Sun 9 Aug 2026 (W1–W8, all full)
// + W9 ⚡ partial: Mon 10 Aug – Wed 12 Aug 2026 (run at 10:04 IST)
// Forms: freshly processed from XLSX exports 12 Aug 2026 (99 enq · 110 app)
// Paythen: 44 unique Registered rows in window (39 pre-window excluded · 2 non-reg excluded)
// Revenue tiers: €689.00 / €709.49 / €733.95
// ─────────────────────────────────────────────────────────────────────────────
export const data = [
  ...
  { week: "10–12 Aug ⚡", forms:  9, regs:  1, revenue:   689.00, full: false },
].map(d => ({
  ...d,
    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", padding: "32px 24px",
      ...
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
          15 Jun – 9 Aug 2026 · W1–W8 (full) + W9 ⚡ partial to 12 Aug
        </p>
      </div>
      ...
      <div style={{ background: "rgba(52,211,153,0.08)", border: "1px solid #34d399",
        ...
        W3 (29 Jun–5 Jul) was the standout week — <strong style={{ color: "#f1f5f9" }}>13 registrations</strong> and{" "}
        <strong style={{ color: "#f1f5f9" }}>{fmt(9361.55)}</strong> revenue from 46 form submissions.
        Overall conversion rate is <strong style={{ color: "#f1f5f9" }}>{overallCR}%</strong> across the window,
        with activity softening through July before a modest W8 uptick. Total pipeline revenue:{" "}
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24, flexWrap: "wrap" }}>
        {[
          ...
          <div key={k.label} style={{ background: "#1e293b", borderRadius: 10,
            padding: "12px 18px", flex: "1 1 120px", border: "1px solid #334155" }}>
            <p style={{ margin: "0 0 3px", fontSize: 10, color: "#64748b",
              textTransform: "uppercase", letterSpacing: "0.06em" }}>{k.label}</p>
            <p style={{ margin: "0 0 2px", fontSize: k.label === "Expected Revenue" ? 18 : 22,
          ...
          <tbody>
            ...
            <tr style={{ background: "#0f172a", borderTop: "2px solid #334155" }}>
              <td colSpan={2} style={{ padding: "11px 14px", color: "#94a3b8",
                fontWeight: 700, fontSize: 10, textTransform: "uppercase" }}>Total</td>
