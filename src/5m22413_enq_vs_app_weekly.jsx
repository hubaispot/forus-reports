...
const avgEnq     = (totalEnq / data.length).toFixed(1);
const avgApp     = (totalApp / data.length).toFixed(1);
    ...
    <div style={{ background: "#0f172a", minHeight: "100vh", padding: "32px 24px",
      ...
      <div style={{ marginBottom: 24 }}>
        <p style={{ color: "#64748b", fontSize: 12, textTransform: "uppercase", letterSpacing: "0.08em", margin: "0 0 6px" }}>
          HubSpot · ELC Level 5 &amp; 6 – Live and Online (5M22413)
        </p>
        <h1 style={{ margin: "0 0 4px", fontSize: 22, fontWeight: 700, color: "#f8fafc" }}>
          Weekly Form Submissions — Enquiry vs Application
        </h1>
        <p style={{ margin: 0, color: "#94a3b8", fontSize: 13 }}>
          14 Apr – 7 Jun 2026 · 8 complete weeks · Unique contacts · last form only per contact
        </p>
      </div>
      ...
      <div style={{ background: "rgba(52,211,153,0.08)", border: "1px solid #34d399", borderRadius: 8,
        ...
        5 of 8 weeks hit the 60%+ threshold 🔥. W8 (1–7 Jun) shows a shift with enquiries outpacing
        applications for the first time, suggesting a new cohort of contacts entering the top of funnel
        following W7's peak activity.
      </div>
      ...
      <div style={{ display: "flex", gap: 10, marginBottom: 24, flexWrap: "wrap" }}>
        {[
          ...
          { label: "Peak Week",          value: "W7",             sub: "26 May–1 Jun · 11 submissions", color: "#fbbf24" },
        ].map(k => (
              ...
              return (
                <tr key={i} style={{ borderBottom: i < data.length - 1 ? "1px solid #1e2d3d" : "none",
                  ...
                  <td style={{ padding: "11px 14px", textAlign: "center", fontWeight: 700, color: COLORS.enq, fontSize: 15 }}>
                    {row.enq}
                    {wowEnq !== null && row.total > 0 && <span style={{ fontSize: 10, marginLeft: 4,
                      color: wowEnq > 0 ? "#34d399" : wowEnq < 0 ? "#f87171" : "#64748b" }}>
                  ...
                  <td style={{ padding: "11px 14px", textAlign: "center", fontWeight: 700, color: COLORS.app, fontSize: 15 }}>
                    {row.app}
                    {wowApp !== null && <span style={{ fontSize: 10, marginLeft: 4,
                      color: wowApp > 0 ? "#34d399" : wowApp < 0 ? "#f87171" : "#64748b" }}>
                  ...
                  <td style={{ padding: "11px 14px", textAlign: "center", fontWeight: 700, fontSize: 12,
                    color: rateHigh ? "#34d399" : row.total === 0 ? "#334155" : COLORS.rate }}>
